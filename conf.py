...
BLOG_TITLE = "Data Science With Python Re-Do"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://necromuralist.github.io/data_science_redo/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "necromuralist@protonmail.com"
BLOG_DESCRIPTION = "A re-do of problems from the Coursera 'Data Science With Python' with alternate problems to avoid violating the student Code of Conduct."  # (translatable)
